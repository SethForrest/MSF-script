...
--gg.alert(' MSF ')
print('@Monikr, @Backlift, @Nofear => "GameGuardian.net" / "SBenny.com" \n V: 1143')
gg.require('8.57.0')
gg.clearResults()
...
var1 = gg.choice({'Character Gamora Data', 'Character 2 Data', 'Character 3 Data', 'Character 4 Data', 'Character 5 Data', 'Hack Menu', 'Wait at Background', 'Exit'}, nil, 'Main Menu')
if var1 == 1
...
::character1menu::
gg.alert('Loading Gamora Stats')
vch1 = gg.prompt({'CURRENT Health', 'CURRENT Speed', 'CURRENT Damage'}, {38449, 130, 3643}, {'number', 'number', 'number'})
if vch1 == nil
...
::restarthackmenu::
gg.clearResults()
var2 = gg.choice({'Quake Hack', 'Character 2 Hack', 'Character 3 Hack', 'Character 4 Hack', 'Character 5 Hack', 'Hack All(REQUIRES FULL SQUAD)', 'Wait at Background', 'Return to main menu'}, nil, 'Hack Menu')
if var2 == 1
then goto quakeHack
elseif var2 == 2
...
--gg.alert('Loading Gamora Stats')
vch1 = gg.prompt({'CURRENT Health', 'CURRENT Speed', 'CURRENT Damage'}, {30497, 102, 3924}, {'number', 'number', 'number'})
if vch1 == nil
then goto inputinvalid
end
